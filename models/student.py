...
class SeStudent(models.Model):
    ...
    first_name = fields.Char(string="First Name", size=128, translate=True)
    middle_name = fields.Char(string="Middle Name", size=128, translate=True)
    last_name = fields.Char(string="Last Name", size=128, translate=True)
    ...
    gr_no = fields.Char(string="Student ID Number", size=20)
